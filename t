...
<!-- [OPT] Meta description untuk SEO -->
<meta name="description" content="Fachri Akbar — Web Engineer & Vibe Coder. Membangun sistem modern, efisien, dan scalable dengan clean architecture. PHP, JavaScript, Tailwind CSS.">
<!-- [OPT] Cache control tetap (browser cache) -->
<meta http-equiv="Cache-Control" content="no-cache, no-store, must-revalidate">
<meta http-equiv="Pragma" content="no-cache">
<meta http-equiv="Expires" content="0">
<title>portofolio-barz</title>

<!-- [OPT] Preconnect sebelum font request untuk mengurangi DNS lookup time -->
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link rel="preconnect" href="https://cdnjs.cloudflare.com" crossorigin>
<link rel="preconnect" href="https://cdn.jsdelivr.net" crossorigin>

<!-- [OPT] Preload hero image sebagai LCP element -->
<link rel="preload" as="image" href="img/barz.jpeg" fetchpriority="high">

<!-- [OPT] Font dengan display=swap mencegah FOIT, non-render-blocking -->
<link href="https://fonts.googleapis.com/css2?family=Syne:wght@400;600;700;800&family=DM+Sans:ital,wght@0,300;0,400;0,500;1,300&display=swap" rel="stylesheet">

<!-- [OPT] Font Awesome dimuat secara async agar tidak blocking render -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" media="print" onload="this.media='all'">
<noscript><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"></noscript>

<!-- [OPT] Devicon dimuat secara async -->
...
#canvas-bg{
  ...
  /* [OPT] GPU layer promotion untuk canvas agar tidak trigger main-thread repaint */
...
.grid-overlay{
  ...
  /* [OPT] Promote ke composited layer */
  transform:translateZ(0);
}
...
nav{
  ...
  /* [OPT] transform saja untuk posisi, GPU composited */
  transform:translateX(-50%);
  z-index:1000;
  background:rgba(5,8,16,0.7);
  backdrop-filter:blur(12px); /* [OPT] dikurangi dari 20px → 12px, lebih ringan GPU */
  -webkit-backdrop-filter:blur(12px);
  border:1px solid var(--border);
  border-radius:50px;
  padding:10px 8px;
  display:flex;align-items:center;gap:4px;
  /* [OPT] transition hanya pada opacity & box-shadow, tidak trigger layout */
  transition:opacity .3s,box-shadow .3s;
  will-change:transform; /* hint browser bahwa el ini composite */
}
nav.scrolled{
...
.nav-link{
  ...
  border-radius:50px;
  /* [OPT] transition hanya color, tidak layout */
  transition:color .3s;
  z-index:1;
  letter-spacing:.02em;
}
...
.nav-indicator{
  ...
  border-radius:50px;
  /* [OPT] Gunakan transform & opacity saja, GPU composited */
...
#hero{
  ...
  padding-top:80px;
  /* [OPT] Contain paint agar tidak repaint body */
  contain:content;
}
.hero-inner{
...
.hero-tag{
  ...
  font-size:12.5px;font-family:'Syne',sans-serif;font-weight:600;
...
.hero-tag span.dot{
  ...
  /* [OPT] GPU composited via opacity+transform */
  will-change:opacity,transform;
}
/* [OPT] Pulse pakai opacity+transform bukan box-shadow/background */
...
.rotate-list{
  ...
  /* [OPT] GPU composited via transform */
  will-change:transform;
}
.rotate-list li{
  height:1.2em;
...
/* [OPT] translateY sudah GPU composited */
...
.btn-primary{
  ...
  /* [OPT] transform+box-shadow GPU composited */
  transition:transform .25s,box-shadow .25s;
  box-shadow:0 4px 24px rgba(91,127,255,0.35);
  will-change:transform;
}
.btn-primary:hover{transform:translateY(-2px);box-shadow:0 8px 32px rgba(91,127,255,0.5)}
.btn-ghost{
  display:inline-flex;align-items:center;gap:8px;
...
.hero-avatar-ring{
  position:relative;
  /* [OPT] Explicit size untuk LCP image container */
...
.ring-outer{
  ...
  border-radius:50%;
  border:1px solid rgba(91,127,255,0.2);
  /* [OPT] GPU composited transform untuk animasi rotasi */
...
/* [OPT] Spin pakai transform saja — sudah composited */
...
.avatar-img{
  ...
  border-radius:50%;
  /* [OPT] Decoding async untuk image non-blocking */
  decoding:async;
}
.badge-float{
  position:absolute;
  ...
  backdrop-filter:blur(8px); /* [OPT] dikurangi dari 12px */
  -webkit-backdrop-filter:blur(8px);
  white-space:nowrap;
}
.badge-float.b1{bottom:20px;left:-20px;color:var(--accent)}
.badge-float.b2{top:40px;right:-10px;color:var(--accent2)}
...
.skill-bar-fill{
  ...
  background:linear-gradient(90deg,var(--accent),var(--accent2));
  width:0%;
  /* [OPT] transition pakai transform saja untuk bar fill */
...
.project-card{
  ...
  overflow:hidden;
  cursor:pointer;
  /* [OPT] transform+opacity GPU composited */
...
.project-thumb{
  width:100%;
  height:200px;
  background:linear-gradient(135deg,rgba(91,127,255,0.1),rgba(139,92,246,0.1));
  display:flex;align-items:center;justify-content:center;
  font-size:60px;
...
.project-thumb .thumb-overlay{
  position:absolute;inset:0;
  background:linear-gradient(to bottom, transparent 50%, rgba(5,8,16,.9));
}
...
.project-arrow{
  ...
  font-size:13px;font-weight:700;
  color:var(--accent);
  /* [OPT] hanya gap transition — ringan */
  transition:gap .25s;
}
...
.modal-overlay{
  ...
  backdrop-filter:blur(6px); /* [OPT] dikurangi dari 8px */
  -webkit-backdrop-filter:blur(6px);
  display:flex;align-items:center;justify-content:center;
  padding:24px;
  opacity:0;pointer-events:none;
  /* [OPT] transition hanya opacity — composited */
...
.modal-hero-img{
  ...
  cursor:zoom-in;border:1px solid var(--border);position:relative;
}
.modal-hero-img img{width:100%;display:block;object-fit:cover}
.img-detail-overlay{
...
.img-detail-overlay.open{opacity:1;pointer-events:all}
.img-detail-box{position:relative;max-width:900px;width:100%}
.img-detail-box img{width:100%;border-radius:16px;border:1px solid var(--border)}
.img-detail-close{
...
.img-detail-close:hover{background:rgba(255,255,255,0.2)}
.modal-box{
  ...
  /* [OPT] transform+opacity GPU composited untuk modal open */
...
.modal-feature-list li::before{content:'→';color:var(--accent);font-family:'Syne',sans-serif;font-weight:700;flex-shrink:0}
...
.contact-link-arrow{color:var(--muted);font-size:18px}
...
.contact-cta p{font-size:15px;color:var(--muted);line-height:1.8;margin-bottom:28px}
...
.reveal{
  opacity:0;
  /* [OPT] transform+opacity — GPU composited, tidak trigger layout */
...
@media(max-width:768px){
  ...
  .hero-img-wrap{display:flex;margin-top:40px}
  .hero-avatar-ring{width:260px;height:260px}
  .avatar-circle{inset:16px}
  ...
  /* [OPT] Kurangi beban animasi di mobile */
...
/* [OPT] Prefers-reduced-motion — aksesibilitas & performa */
...
::-webkit-scrollbar-thumb{background:rgba(91,127,255,0.3);border-radius:3px}
</style>
</head>
<body>

<canvas id="canvas-bg" width="1" height="1" aria-hidden="true"></canvas>
  ...
  <div class="container">
    <div class="hero-inner">
      <div class="hero-content">
        <div class="hero-tag"><span class="dot" aria-hidden="true"></span>Available for Projects</div>
        <h1 class="hero-name">
          <div class="line1">Halo, Saya</div>
          <div class="line2">Fachri Akbar</div>
        </h1>
        <div class="hero-role-wrap" aria-label="Seorang Vibe Coder">
          <span class="prefix">Seorang</span>
          <div class="rotate-wrapper" aria-hidden="true">
      ...
      <div class="hero-img-wrap">
        <div class="hero-avatar-ring">
          ...
          <div class="avatar-circle">
            <!-- [OPT] fetchpriority=high + decoding=async untuk LCP hero image -->
            <!-- [OPT] Explicit width & height mencegah layout shift (CLS) -->
            <img
              src="img/barz.jpeg"
              alt="Fachri Akbar — Web Engineer"
              class="avatar-img"
              width="280"
              height="280"
              fetchpriority="high"
          ...
          <div class="badge-float b1" aria-hidden="true">Engineering</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div>
      <div class="reveal">
        ...
        <h2 class="section-title">Engineer yang<br>Berpikir Sistemik</h2>
    ...
    <div class="about-visual reveal reveal-delay-2">
      ...
      <div class="terminal-code" role="img" aria-label="Konfigurasi engineer Fachri Akbar">
        <div class="tc-comment">// fachri.config.js</div>
        <div><span class="tc-blue">const</span> <span class="tc-green">engineer</span> = {</div>
        <div>&nbsp;&nbsp;name: <span class="tc-purple">'Fachri Akbar'</span>,</div>
        <div>&nbsp;&nbsp;role: <span class="tc-purple">'Web Engineer'</span>,</div>
        <div>&nbsp;&nbsp;focus: [</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="tc-purple">'Clean Architecture'</span>,</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="tc-purple">'System Design'</span>,</div>
        <div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="tc-purple">'Modern UI'</span>,</div>
        <div>&nbsp;&nbsp;],</div>
        <div>&nbsp;&nbsp;available: <span class="tc-green">true</span>,</div>
        <div>};</div>
        <br>
        <div class="tc-comment">// ✓ Open for opportunities</div>
      </div>
    </div>
  </div>
</section>
...
<section id="skills">
  <div class="container">
    <div class="reveal" style="text-align:center;margin-bottom:60px">
      ...
      <h2 class="section-title">Skills & Keahlian</h2>
      <div class="section-line" style="margin:16px auto 0"></div>
    </div>
    <div class="skills-grid">
      <div class="skill-item reveal" data-delay="0">
        <div class="skill-top">
          <div class="skill-name"><span class="skill-icon" aria-hidden="true"><i class="fab fa-html5" style="color:#e34f26"></i></span> HTML5</div>
          <div class="skill-pct">95%</div>
        </div>
        <div class="skill-bar-bg" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" aria-label="HTML5 proficiency 95%"><div class="skill-bar-fill" data-width="95"></div></div>
      </div>
      <div class="skill-item reveal reveal-delay-1" data-delay="1">
        <div class="skill-top">
          <div class="skill-name"><span class="skill-icon" aria-hidden="true"><i class="fab fa-css3-alt" style="color:#1572b6"></i></span> CSS3</div>
          <div class="skill-pct">92%</div>
        </div>
        <div class="skill-bar-bg" role="progressbar" aria-valuenow="92" aria-valuemin="0" aria-valuemax="100" aria-label="CSS3 proficiency 92%"><div class="skill-bar-fill" data-width="92"></div></div>
      </div>
      <div class="skill-item reveal reveal-delay-2">
        <div class="skill-top">
          <div class="skill-name"><span class="skill-icon" aria-hidden="true"><i class="fab fa-js" style="color:#f7df1e"></i></span> JavaScript</div>
          <div class="skill-pct">88%</div>
        </div>
        <div class="skill-bar-bg" role="progressbar" aria-valuenow="88" aria-valuemin="0" aria-valuemax="100" aria-label="JavaScript proficiency 88%"><div class="skill-bar-fill" data-width="88"></div></div>
      </div>
      <div class="skill-item reveal reveal-delay-3">
        <div class="skill-top">
          <div class="skill-name"><span class="skill-icon" aria-hidden="true"><i class="fab fa-php" style="color:#777bb4"></i></span> PHP</div>
          <div class="skill-pct">90%</div>
        </div>
        <div class="skill-bar-bg" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" aria-label="PHP proficiency 90%"><div class="skill-bar-fill" data-width="90"></div></div>
      </div>
      <div class="skill-item reveal reveal-delay-1">
        <div class="skill-top">
          <div class="skill-name"><span class="skill-icon" aria-hidden="true"><i class="devicon-tailwindcss-original colored" style="font-size:18px"></i></span> Tailwind CSS</div>
          <div class="skill-pct">90%</div>
        </div>
        <div class="skill-bar-bg" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" aria-label="Tailwind CSS proficiency 90%"><div class="skill-bar-fill" data-width="90"></div></div>
      </div>
      <div class="skill-item reveal reveal-delay-2">
        <div class="skill-top">
          <div class="skill-name"><span class="skill-icon" aria-hidden="true"><i class="fas fa-database" style="color:#4479a1"></i></span> MySQL</div>
          <div class="skill-pct">82%</div>
        </div>
        <div class="skill-bar-bg" role="progressbar" aria-valuenow="82" aria-valuemin="0" aria-valuemax="100" aria-label="MySQL proficiency 82%"><div class="skill-bar-fill" data-width="82"></div></div>
      </div>
    </div>
  </div>
</section>
...
<section id="projects">
  <div class="container">
    ...
    <div class="projects-grid">
      ...
      <div class="project-card reveal" onclick="openModal('timetracker')" role="button" tabindex="0" aria-label="Lihat detail Time Tracker App" onkeydown="if(event.key==='Enter')openModal('timetracker')">
        <div class="project-thumb">
          <!-- [OPT] loading=lazy untuk project images (below fold) -->
          <!-- [OPT] Explicit width & height untuk mencegah CLS -->
          <img src="img/image.png" alt="Time Tracker App" width="400" height="200" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;">
        ...
        <div class="project-body">
          ...
          <div class="project-title">Time Tracker App</div>
          <p class="project-desc">Aplikasi manajemen waktu untuk membantu orang yang bekerja sambil kuliah agar lebih produktif dan terorganisir.</p>
      ...
      <div class="project-card reveal" onclick="openModal('pendaftaran')" role="button" tabindex="0" aria-label="Lihat detail Sistem Pendaftaran Siswa Baru" onkeydown="if(event.key==='Enter')openModal('pendaftaran')">
        <div class="project-thumb">
          <img src="img/ppdb.png" alt="Sistem Pendaftaran Siswa Baru (PPDB)" width="400" height="200" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;">
          <div class="thumb-overlay" aria-hidden="true"></div>
        </div>
        <div class="project-body">
          <div class="project-tags">
      ...
      <!-- Project 3: Parkir -->
      <div class="project-card reveal reveal-delay-1" onclick="openModal('parkir')" role="button" tabindex="0" aria-label="Lihat detail Sistem Parkir Otomatis" onkeydown="if(event.key==='Enter')openModal('parkir')">
        <div class="project-thumb">
          <img src="img/parkir.png" alt="Sistem Parkir Otomatis" width="400" height="200" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;">
          <div class="thumb-overlay" aria-hidden="true"></div>
        </div>
        <div class="project-body">
          <div class="project-tags">
          ...
          <div class="project-title">Sistem Parkir Otomatis</div>
          <p class="project-desc">Sistem manajemen parkir dengan barcode scanner, perhitungan tarif otomatis, dan laporan kendaraan harian.</p>
          <div class="project-arrow" aria-hidden="true">
            Detail Project <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
          </div>
        </div>
      ...
      <div class="project-card reveal reveal-delay-1" onclick="openModal('photobooth')" role="button" tabindex="0" aria-label="Lihat detail Aplikasi Photobooth Web" onkeydown="if(event.key==='Enter')openModal('photobooth')">
        <div class="project-thumb">
          <img src="img/poto.png" alt="Aplikasi Photobooth Web" width="400" height="200" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;">
          <div class="thumb-overlay" aria-hidden="true"></div>
        </div>
        <div class="project-body">
          <div class="project-tags">
      ...
      <div class="project-card reveal reveal-delay-2" onclick="openModal('panelin')" role="button" tabindex="0" aria-label="Lihat detail Manajemen ElektroPanel" onkeydown="if(event.key==='Enter')openModal('panelin')">
        <div class="project-thumb">
          <img src="img/panel.png" alt="Manajemen ElektroPanel" width="400" height="200" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;">
          <div class="thumb-overlay" aria-hidden="true"></div>
        </div>
        <div class="project-body">
          <div class="project-tags">
      ...
      <div class="project-card reveal reveal-delay-3" onclick="openModal('psbooking')" role="button" tabindex="0" aria-label="Lihat detail PS Booking System" onkeydown="if(event.key==='Enter')openModal('psbooking')">
        <div class="project-thumb">
          <img src="img/ps.png" alt="PS Booking System" width="400" height="200" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;">
          <div class="thumb-overlay" aria-hidden="true"></div>
        </div>
        <div class="project-body">
          <div class="project-tags">
      ...
      <div class="project-card reveal" onclick="openModal('simas')" role="button" tabindex="0" aria-label="Lihat detail SIMAS System" onkeydown="if(event.key==='Enter')openModal('simas')">
        <div class="project-thumb">
          <img src="img/simas.png" alt="SIMAS System — Sistem Manajemen Absensi" width="400" height="200" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;">
          <div class="thumb-overlay" aria-hidden="true"></div>
        </div>
        <div class="project-body">
          <div class="project-tags">
      ...
      <div class="project-card reveal" onclick="openModal('simano')" role="button" tabindex="0" aria-label="Lihat detail SIMANO System" onkeydown="if(event.key==='Enter')openModal('simano')">
        <div class="project-thumb">
          <img src="img/simano.png" alt="SIMANO System — Rebuild PHP MVC" width="400" height="200" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;">
          <div class="thumb-overlay" aria-hidden="true"></div>
        </div>
        <div class="project-body">
          <div class="project-tags">
  ...
  <div class="container">
    <div class="contact-grid">
      <div class="contact-cta reveal">
        ...
        <h3>Mari <span>Berkolaborasi</span><br>Bersama</h3>
        <p>Punya project menarik atau peluang kerja sama? Saya terbuka untuk diskusi dan kolaborasi. Hubungi saya melalui channel berikut.</p>
        <a href="mailto:barzbar17@gmail.com" class="btn-primary">
      ...
      <div class="contact-links reveal reveal-delay-1">
        <a href="https://instagram.com/maskfachri" target="_blank" rel="noopener noreferrer" class="contact-link">
          <div class="contact-link-icon" aria-hidden="true"><i class="fab fa-instagram" style="color:#e4405f"></i></div>
          <div class="contact-link-info">
            <div class="contact-link-label">Instagram</div>
            <div class="contact-link-value">@maskfachri</div>
          </div>
          <div class="contact-link-arrow" aria-hidden="true">→</div>
        </a>
        <a href="mailto:barzbar17@gmail.com" class="contact-link">
          <div class="contact-link-icon" aria-hidden="true"><i class="fas fa-envelope" style="color:#ea4335"></i></div>
          <div class="contact-link-info">
            <div class="contact-link-label">Email</div>
            <div class="contact-link-value">barzbar17@gmail.com</div>
          </div>
          <div class="contact-link-arrow" aria-hidden="true">→</div>
        </a>
        <a href="https://wa.me/6282123996178" target="_blank" rel="noopener noreferrer" class="contact-link">
          <div class="contact-link-icon" aria-hidden="true"><i class="fab fa-whatsapp" style="color:#25d366"></i></div>
          <div class="contact-link-info">
            <div class="contact-link-label">WhatsApp</div>
            <div class="contact-link-value">082123996178</div>
          </div>
          <div class="contact-link-arrow" aria-hidden="true">→</div>
        </a>
        <a href="https://github.com/kingbarz698-cmyk" target="_blank" rel="noopener noreferrer" class="contact-link">
          <div class="contact-link-icon" aria-hidden="true"><i class="fab fa-github" style="color:#fff"></i></div>
          <div class="contact-link-info">
...
<footer>
  <p>Dibuat oleh <span>Fachri Akbar</span> · Web Engineer · 2025</p>
</footer>

<!-- ── MODAL ── -->
<div class="modal-overlay" id="modal-overlay" onclick="handleOverlayClick(event)" role="dialog" aria-modal="true" aria-labelledby="modal-title">
  <div class="modal-box">
...
<div class="img-detail-overlay" id="img-detail-overlay" onclick="closeImageDetail(event)" role="dialog" aria-modal="true" aria-label="Detail gambar project">
  <div class="img-detail-box" onclick="event.stopPropagation()">
    <button class="img-detail-close" onclick="closeImageDetail()" aria-label="Tutup gambar">✕</button>
    <img id="img-detail-img" src="" alt="Detail gambar project" width="900" height="506">
  </div>
</div>
...
/* ── CANVAS BEAM ── */
/* [OPT] Gunakan offscreen rendering + hanya render saat tab visible */
...
/* [OPT] Kurangi jumlah beam & throttle frame rate ke 30fps untuk efisiensi CPU */
const TARGET_FPS = 30;
...
/* [OPT] Debounce resize untuk menghindari thrashing */
let resizeTimer;
...
/* [OPT] 18 → 12 beam: tetap visual sama, 33% lebih ringan */
for (let i = 0; i < 12; i++) {
  const b = new Beam();
...
/* [OPT] Throttled animation loop — 30fps bukan 60fps */
...
/* [OPT] Pause canvas ketika tab tidak aktif (Page Visibility API) */
...
/* [OPT] Cache navRect agar tidak dipanggil setiap moveIndicator */
...
function moveIndicator(el) {
  ...
  /* [OPT] Posisi via left/top absolute (tidak re-layout karena position:absolute) */
...
/* [OPT] Scroll dengan passive:true & throttle via requestAnimationFrame */
...
/* ── SCROLL REVEAL ── */
/* [OPT] Single IntersectionObserver dengan rootMargin untuk trigger lebih awal */
...
/* [OPT] Skill bar observer terpisah agar tidak mix dengan reveal */
...
const projects = {
  timetracker: {
    ...
    desc: 'Aplikasi manajemen waktu yang dirancang khusus untuk membantu individu yang menjalani kehidupan ganda sebagai pekerja sekaligus mahasiswa. Sistem ini memungkinkan tracking waktu secara detail, sehingga produktivitas dapat dimonitor dan ditingkatkan.',
    image: 'img/image.png',
  ...
  parkir: {
    ...
    desc: 'Sistem manajemen parkir berbasis web dengan barcode scanner, perhitungan tarif otomatis berdasarkan durasi, dan laporan kendaraan harian/mingguan untuk memudahkan administrasi area parkir.',
    image: 'img/parkir.png',
    tech: ['PHP', 'MySQL', 'JavaScript', 'Tailwind CSS', 'TCPDF'],
    goal: 'Mendigitalisasi sistem parkir konvensional menjadi solusi otomatis yang efisien, akurat, dan mudah digunakan oleh operator maupun manajemen.',
    features: [
...
function openModal(id) {
  ...
  document.getElementById('modal-body').innerHTML = `
    ${p.image ? `<div class="modal-hero-img" onclick="openImageDetail('${p.image}')"><img src="${p.image}" alt="${p.title}" width="600" height="338" loading="lazy" decoding="async"></div>` : ''}
    <p class="modal-desc">${p.desc}</p>
    <div class="modal-section-title">Teknologi</div>
    <div class="modal-tech-list">
      ${p.tech.map(t => `<span class="tag">${t}</span>`).join('')}
    </div>
    <div class="modal-section-title">Tujuan Project</div>
    <p class="modal-desc">${p.goal}</p>
    <div class="modal-section-title">Fitur Utama</div>
...
function openImageDetail(src) {
  document.getElementById('img-detail-img').src = src;
  document.getElementById('img-detail-overlay').classList.add('open');
}

function closeImageDetail() {
  document.getElementById('img-detail-overlay').classList.remove('open');
}

document.addEventListener('keydown', e => {
  if (e.key === 'Escape') {
    const imgOverlay = document.getElementById('img-detail-overlay');
    if (imgOverlay.classList.contains('open')) {
      closeImageDetail();
    } else {
      closeModal();
    }
